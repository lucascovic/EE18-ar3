...
<div class="container">
        ...
        // Kontrollera att eposten är 6 tecken långt
        if(strlen($epost) < 6){
            echo "<p class\"alert alert-warning\"Eposten måste minst vara 6 tecken långt</p>";
        }
        // Kontrollera att det finns ett @ 
        if (strpos($epost, "@")!== false) {
            echo "<p>Ja, @ finns i epost-adressen</p>";
         } else {
             echo "<p>E-Posten måste ha ett @</p>";
         }
        // Kontrollera att det finns en . 
        if (strpos($epost, ".")!== false) {
            echo "<p>Ja, . finns i epost-adressen</p>";
         } else {
             echo "<p>E-Posten måste ha en .</p>";
         }
        }
        ?>
    </div>
